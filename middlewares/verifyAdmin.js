// user-server/middlewares/verifyAdmin.js - সংশোধিত কোড
...
const verifyAdmin = (userCollection) => async (req, res, next) => {
    ...
    // আপনার JWT মিডলওয়্যার সম্ভবত req.decoded এ ইমেইল সংরক্ষণ করে।
    ...
    try {
        ...
        const user = await userCollection.findOne(
            { email: email },
            { projection: { role: 1 } } // শুধু রোল ফিল্ডটি নেওয়া
        );
