...
module.exports = function (userCollection) {
    ...
    router.get('/donors-search', async (req, res) => {
        ...
        try {
            // ✅ ফিক্স: শুধুমাত্র password: 0 ব্যবহার করা হলো।
            const donors = await userCollection.find(query, { 
                projection: { 
                    password: 0 // শুধুমাত্র এই একটি ফিল্ড বাদ দেওয়া হলো।
                } 
            }).toArray();
    ...
    // ==================================================================
    // 🔥 ফিক্সড প্রিফিক্সযুক্ত প্যারামিটার রুটগুলি (/role/:email) - মাঝে রাখা হলো 🔥
    // ==================================================================
